...
enum SNKColor {
    ...
    static let backgroundGray = UIColor(red: 18/255, green: 19/255, blue: 18/255, alpha: 1) //matches dark tab bar
    ...
    static let foregroundWhite = UIColor(red: 188/255, green: 255/255, blue: 194/255, alpha: 1)
    static let foregroundGray = UIColor(red: 142/255, green: 142/255, blue: 147/255, alpha: 1) //systemGray in dark mode
    static let destructive = UIColor(red: 255/255, green: 135/255, blue: 99/255, alpha: 1)
