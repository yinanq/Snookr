...
class ScoresView: UIView {
    ...
    private func configure() {
        ...
        scoreLabel1 = SNKLabel(fontSize: 100, fontWeight: .medium, textAlignment: .left)
        scoreLabel2 = SNKLabel(fontSize: 100, fontWeight: .medium, textAlignment: .right)
        ...
        NSLayoutConstraint.activate([
            ...
            scoreLabel1.leadingAnchor.constraint(equalTo: leadingAnchor, constant: SNKPadding.big),
            ...
            scoreLabel2.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -SNKPadding.big),
        ])
    }
